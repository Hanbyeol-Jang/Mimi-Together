...
public class RecommandController {
	...
	@PostMapping("/survey")
	public ResponseEntity<?> create(@RequestBody final RecommandRequest request) throws IOException, InterruptedException{
	...
	@PostMapping("/multi")
	public ResponseEntity<?> recommand_save(@RequestBody final RecommandRequest request) throws InterruptedException, IOException{
